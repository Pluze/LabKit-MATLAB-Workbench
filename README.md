...
- The EIS and Chrono overlay app implementations now live under `apps/private` as the reference direction: app-specific workflow code should sit with the app and compose `+gamrywb` GUI/DTA APIs.
