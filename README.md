...
- The EIS app is now the first public single-file app implementation. Chrono overlay, CSC, VT resistance, and CIC still have transitional `apps/private` launch bodies that should be collapsed back into their public app files.
