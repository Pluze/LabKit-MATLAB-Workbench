...
- Phase 9 started: shared session creation, file add/remove, save/load, batch summary helpers, VT/CIC batch table helpers, and legacy GUI session-state wiring are available.
