...
- EIS and Chrono overlay are now public single-file app implementations. CSC, VT resistance, and CIC still have transitional `apps/private` launch bodies that should be collapsed back into their public app files.
