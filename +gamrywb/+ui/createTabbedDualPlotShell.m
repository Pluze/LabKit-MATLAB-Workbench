function ui = createTabbedDualPlotShell(figName, figPosition, leftWidth, separatorButtonDownFcn)
%CREATETABBEDDUALPLOTSHELL Create the shared tabbed dual-plot app shell.
    ...
    ui.filesAnalysisTab = uitab(ui.tabs, 'Title', 'Files + Analysis');
    ...
    ui.summaryResultsTab = uitab(ui.tabs, 'Title', 'Summary + Results');
