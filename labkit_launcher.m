...
function fig = createLauncherFigure(root, apps)
    ...
    spec = labkit.ui.spec.app('labkitLauncher', 'LabKit App Launcher', ...
        ...
        'controlTabs', { ...
            labkit.ui.spec.tab('findApp', 'Find App', { ...
                labkit.ui.spec.section('filterSection', 'Filter', { ...
                    labkit.ui.spec.statusPanel('launcherSummary', ...
                        'LabKit Apps', ...
            ...
            labkit.ui.spec.tab('statusTab', 'Status', { ...
    ...
    summaryText = ui.controls.launcherSummary.textArea;
