classdef LauncherBootstrapSpec < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'Contract:system', 'Env:headless'})
        ...
        function repairRootKeepsDispatchStaticAndAvoidsRuntimeLogging(testCase)
            ...
            testCase.verifyFalse(contains(source, "str2func("));
            testCase.verifyTrue(contains(source, "labkit.app.internal.launcher.dispatch("));
