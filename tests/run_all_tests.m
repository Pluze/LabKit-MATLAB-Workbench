...
%RUN_ALL_TESTS Run the current MATLAB test suite.
    ...
    tests = {@test_util_functions, @test_phase1_smoke, @test_phase10_apps, @test_parseChronoDTA, @test_parseEISDTA, ...
        @test_parseCVCTDTA, @test_dtaFacade, @test_detectPulses, @test_makeChronoItem, @test_chronoOverlayExport, ...
        @test_computeVTResistance, @test_vtResistanceExport, @test_computeCIC, @test_cicExport, @test_computeCSC, @test_plotCurveXY, ...
        @test_eisOverlayExport, @test_sessionUtilities, @test_appSessionHelpers};
    if includeGui
