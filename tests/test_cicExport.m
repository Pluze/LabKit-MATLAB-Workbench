...
%TEST_CICEXPORT Verify CIC result/export table helpers.
    ...
    item.analysis = gamrywb.analysis.computeCIC(item, opts);
    ...
    T = gamrywb.io.buildCICResultsTable(items, 'mC/cm^2');
    ...
    Tu = gamrywb.io.buildCICResultsTable(item, 'uC/cm^2');
    ...
    [C, cols] = gamrywb.ui.buildCICBatchTableData(items, 'uC/cm^2');
    ...
    gamrywb.io.writeCICResultsCSV(items, tmp, 'mC/cm^2');
    txt = fileread(tmp);
