classdef LegacyGuiLayoutUiDebugTraceTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUIDEBUGTRACETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_debug_trace(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_debug_trace();
        end
    end
end

function legacy_test_gui_layout_ui_debug_trace()
...
function checkExplicitInstrumentation(h)
    ...
    disabled = labkit.ui.diag.createContext('probe_app', struct('traceEnabled', false));
