classdef LegacyGuiLayoutUiImageAxesRuntimeTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUIIMAGEAXESRUNTIMETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_image_axes_runtime(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_image_axes_runtime();
        end
    end
end

function legacy_test_gui_layout_ui_image_axes_runtime()
