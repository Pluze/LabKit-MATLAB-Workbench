classdef LegacyGuiLayoutUiBusyStateTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUIBUSYSTATETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_busy_state(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_busy_state();
        end
    end
end

function legacy_test_gui_layout_ui_busy_state()
