classdef LegacyGuiLayoutUiScaleBarToolTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUISCALEBARTOOLTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_scale_bar_tool(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_scale_bar_tool();
        end
    end
end

function legacy_test_gui_layout_ui_scale_bar_tool()
