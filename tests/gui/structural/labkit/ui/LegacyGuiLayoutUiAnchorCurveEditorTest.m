classdef LegacyGuiLayoutUiAnchorCurveEditorTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUIANCHORCURVEEDITORTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_anchor_curve_editor(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_anchor_curve_editor();
        end
    end
end

function legacy_test_gui_layout_ui_anchor_curve_editor()
%TEST_GUI_LAYOUT_UI_ANCHOR_CURVE_EDITOR Verify anchor curve editor contracts.
    ...
    changed = false;
    editor = labkit.ui.tool.anchorEditor(runtime, [40 60 3], ...
        struct('closed', true, ...
        'style', 'Curve', ...
    ...
    twoPointEditor = labkit.ui.tool.anchorEditor(runtime, [40 60 3], ...
    ...
    openEditor = labkit.ui.tool.anchorEditor(runtime, [40 60 3], ...
    ...
    spiralEditor = labkit.ui.tool.anchorEditor(runtime, [60 70 3], ...
        struct('closed', false, 'style', 'Straight lines'));
    ...
    crossingEditor = labkit.ui.tool.anchorEditor(runtime, [100 120 3], ...
        struct('closed', false, 'style', 'Straight lines'));
    ...
    scrollEditor = labkit.ui.tool.anchorEditor(runtime2, [40 60 3], ...
        struct('closed', false, 'style', 'Straight lines'));
    ...
    runtime3 = labkit.ui.tool.createRuntime(ax3, struct('figure', fig3));
    firstEditor = labkit.ui.tool.anchorEditor(runtime3, [40 60 3], ...
        struct('closed', false, 'style', 'Straight lines'));
    secondEditor = labkit.ui.tool.anchorEditor(runtime3, [40 60 3], ...
        struct('closed', false, 'style', 'Straight lines'));
