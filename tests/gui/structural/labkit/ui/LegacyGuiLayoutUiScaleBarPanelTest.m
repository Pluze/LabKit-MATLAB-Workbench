classdef LegacyGuiLayoutUiScaleBarPanelTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUISCALEBARPANELTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_scale_bar_panel(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_scale_bar_panel();
        end
    end
end

function legacy_test_gui_layout_ui_scale_bar_panel()
