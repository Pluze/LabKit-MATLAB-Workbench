classdef LegacyGuiLayoutUiAxesWorkbenchTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTUIAXESWORKBENCHTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_ui_axes_workbench(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_ui_axes_workbench();
        end
    end
end

function legacy_test_gui_layout_ui_axes_workbench()
