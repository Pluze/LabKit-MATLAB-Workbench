classdef LegacyGuiLayoutDicTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTDICTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_dic(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_dic();
        end
    end
end

function legacy_test_gui_layout_dic()
