classdef GuiLayoutDicTest < matlab.uitest.TestCase
    %GUILAYOUTDICTEST Verify LabKit behavior through official MATLAB tests.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_dic(testCase)
            setupLabKitTestPath();
            verify_gui_layout_dic();
        end
    end
end

function verify_gui_layout_dic()
