classdef LegacyGuiLayoutElectrochemTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTELECTROCHEMTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_electrochem(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_electrochem();
        end
    end
end

function legacy_test_gui_layout_electrochem()
