classdef GuiLayoutElectrochemTest < matlab.uitest.TestCase
    %GUILAYOUTELECTROCHEMTEST Verify LabKit behavior through official MATLAB tests.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_electrochem(testCase)
            setupLabKitTestPath();
            verify_gui_layout_electrochem();
        end
    end
end

function verify_gui_layout_electrochem()
