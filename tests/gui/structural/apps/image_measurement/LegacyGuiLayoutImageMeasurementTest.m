classdef LegacyGuiLayoutImageMeasurementTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTIMAGEMEASUREMENTTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_image_measurement(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_image_measurement();
        end
    end
end

function legacy_test_gui_layout_image_measurement()
