classdef LegacyGuiLayoutWearableTest < matlab.uitest.TestCase
    %LEGACYGUILAYOUTWEARABLETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'GUI', 'Structural'})
        function test_gui_layout_wearable(testCase)
            setupLabKitTestPath();
            legacy_test_gui_layout_wearable();
        end
    end
end

function legacy_test_gui_layout_wearable()
