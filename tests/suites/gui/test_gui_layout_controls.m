...
function checkTabbedWorkbenchShellHelper()
    labels = struct( ...
        'controlsPanel', 'Controls', ...
        'rightPanel', 'Plots');
    tabSpecs = struct( ...
    ...
    ui = labkit.ui.createTabbedWorkbenchShell( ...
        'labkit_tabbed_workbench_shell_probe', ...
        [40 30 1200 760], ...
        360, ...
        labels, ...
        tabSpecs, ...
    ...
    assert(isequal(ui.main.ColumnWidth, {360, 6, '1x'}), ...
        'Tabbed workbench shell should create a left/separator/right layout.');
    assert(strcmp(ui.leftPanel.Title, 'Controls'), ...
        'Tabbed workbench shell should preserve the controls title.');
    assert(strcmp(ui.rightPanel.Title, 'Plots'), ...
        'Tabbed workbench shell should preserve the right panel title.');
    assertTabTitles(ui.fig, {'Probe Controls'});
    assertScrollablePanel(ui.probeScrollPanel, 'Probe Controls tab');
    assert(sameStringCell(ui.probeGrid.RowHeight, {'fit', '1x'}), ...
