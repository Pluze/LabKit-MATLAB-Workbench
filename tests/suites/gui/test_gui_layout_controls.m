...
function checkDICPreprocess()
    ...
    assertComponentCounts(fig, struct('Button', 18, 'DropDown', 1, ...
        'TextArea', 4, 'Axes', 2));
    assertButtonContract(fig, {'Open reference image', 'Open moving image', ...
        ...
        'Start ROI edit', 'Add point', 'Move point', ...
        'Delete point', 'Preview ROI mask', ...
        'Undo point', 'Clear ROI', 'Save ROI mask'});
    assertDropdownGroups(fig, dropdownGroup({'Current pair', 'Current moving image', ...
