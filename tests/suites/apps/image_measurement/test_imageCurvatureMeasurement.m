...
function checkPixelAndManualScaleModes()
    ...
    pxOnly = labkit_CurvatureMeasurement_app('__test_computeCurvatureFit__', x, y, ...
    ...
    manualScale = labkit_CurvatureMeasurement_app('__test_computeCurvatureFit__', x, y, ...
