...
function checkSyntheticFocusSelection()
    ...
    result = labkit_FocusStack_app('__labkit_test__', ...
...
function checkSummaryTableContract()
    ...
    T = labkit_FocusStack_app('__labkit_test__', ...
    ...
    assert(T.FocusWindow_px(1) == result.focusWindow, ...
        'Summary table should preserve focus-window option.');
    assert(T.MaskSmoothing_px(1) == result.smoothRadius, ...
        'Summary table should preserve smoothing option.');
end
...
function checkFolderDiscovery()
    ...
    paths = labkit_FocusStack_app('__labkit_test__', 'findFocusStackImages', folder);
