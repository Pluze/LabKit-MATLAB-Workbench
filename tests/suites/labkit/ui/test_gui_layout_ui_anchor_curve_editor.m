...
%TEST_GUI_LAYOUT_UI_ANCHOR_CURVE_EDITOR Verify anchor curve editor contracts.
    ...
    twoPointEditor = labkit.ui.createAnchorCurveEditor(runtime, [40 60 3], ...
    ...
    openEditor = labkit.ui.createAnchorCurveEditor(runtime, [40 60 3], ...
    ...
    spiralEditor = labkit.ui.createAnchorCurveEditor(runtime, [60 70 3], ...
        struct('closed', false, 'style', 'Straight lines'));
    ...
    crossingEditor = labkit.ui.createAnchorCurveEditor(runtime, [100 120 3], ...
        struct('closed', false, 'style', 'Straight lines'));
