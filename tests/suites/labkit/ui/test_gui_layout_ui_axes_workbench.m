...
function checkCreateAppShellHelper(h)
    ...
    custom = labkit.ui.createAppShell(struct( ...
    ...
    dual = labkit.ui.createAppShell(struct( ...
    ...
    dualNoControls = labkit.ui.createAppShell(struct( ...
...
function shell = createDualPlotWorkbenchForTest(figName)
    ...
    shell = labkit.ui.createAppShell(struct( ...
        'title', figName, ...
