classdef LegacyAppHookHelpersTest < matlab.unittest.TestCase
    %LEGACYAPPHOOKHELPERSTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_appHookHelpers(testCase)
            setupLabKitTestPath();
            legacy_test_appHookHelpers();
        end
    end
end

function legacy_test_appHookHelpers()
