classdef LegacyScaleBarCalibrationTest < matlab.unittest.TestCase
    %LEGACYSCALEBARCALIBRATIONTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_scaleBarCalibration(testCase)
            setupLabKitTestPath();
            legacy_test_scaleBarCalibration();
        end
    end
end

function legacy_test_scaleBarCalibration()
