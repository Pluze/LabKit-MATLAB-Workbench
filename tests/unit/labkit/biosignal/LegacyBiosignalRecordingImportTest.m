classdef LegacyBiosignalRecordingImportTest < matlab.unittest.TestCase
    %LEGACYBIOSIGNALRECORDINGIMPORTTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_biosignalRecordingImport(testCase)
            setupLabKitTestPath();
            legacy_test_biosignalRecordingImport();
        end
    end
end

function legacy_test_biosignalRecordingImport()
