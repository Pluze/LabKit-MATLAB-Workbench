classdef BiosignalSegmentsMeasurementsTest < matlab.unittest.TestCase
    %BIOSIGNALSEGMENTSMEASUREMENTSTEST Verify LabKit behavior through official MATLAB tests.

    methods (Test, TestTags = {'Unit'})
        function test_biosignalSegmentsMeasurements(testCase)
            setupLabKitTestPath();
            verify_biosignalSegmentsMeasurements();
        end
    end
end

function verify_biosignalSegmentsMeasurements()
