classdef LegacyBiosignalDelimitedImportTest < matlab.unittest.TestCase
    %LEGACYBIOSIGNALDELIMITEDIMPORTTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_biosignalDelimitedImport(testCase)
            setupLabKitTestPath();
            legacy_test_biosignalDelimitedImport();
        end
    end
end

function legacy_test_biosignalDelimitedImport()
