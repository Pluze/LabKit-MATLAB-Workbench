classdef LegacyBiosignalSegmentsMeasurementsTest < matlab.unittest.TestCase
    %LEGACYBIOSIGNALSEGMENTSMEASUREMENTSTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_biosignalSegmentsMeasurements(testCase)
            setupLabKitTestPath();
            legacy_test_biosignalSegmentsMeasurements();
        end
    end
end

function legacy_test_biosignalSegmentsMeasurements()
