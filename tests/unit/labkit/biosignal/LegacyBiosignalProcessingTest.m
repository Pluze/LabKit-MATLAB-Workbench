classdef LegacyBiosignalProcessingTest < matlab.unittest.TestCase
    %LEGACYBIOSIGNALPROCESSINGTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_biosignalProcessing(testCase)
            setupLabKitTestPath();
            legacy_test_biosignalProcessing();
        end
    end
end

function legacy_test_biosignalProcessing()
