classdef LegacyMakeChronoItemTest < matlab.unittest.TestCase
    %LEGACYMAKECHRONOITEMTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_makeChronoItem(testCase)
            setupLabKitTestPath();
            legacy_test_makeChronoItem();
        end
    end
end

function legacy_test_makeChronoItem()
