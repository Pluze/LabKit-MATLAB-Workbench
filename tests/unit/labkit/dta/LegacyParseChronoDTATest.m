classdef LegacyParseChronoDTATest < matlab.unittest.TestCase
    %LEGACYPARSECHRONODTATEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_parseChronoDTA(testCase)
            setupLabKitTestPath();
            legacy_test_parseChronoDTA();
        end
    end
end

function legacy_test_parseChronoDTA()
