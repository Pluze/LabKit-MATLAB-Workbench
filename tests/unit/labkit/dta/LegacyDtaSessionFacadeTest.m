classdef LegacyDtaSessionFacadeTest < matlab.unittest.TestCase
    %LEGACYDTASESSIONFACADETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_dtaSessionFacade(testCase)
            setupLabKitTestPath();
            legacy_test_dtaSessionFacade();
        end
    end
end

function legacy_test_dtaSessionFacade()
