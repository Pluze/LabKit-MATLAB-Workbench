classdef LegacyParseCVCTDTATest < matlab.unittest.TestCase
    %LEGACYPARSECVCTDTATEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_parseCVCTDTA(testCase)
            setupLabKitTestPath();
            legacy_test_parseCVCTDTA();
        end
    end
end

function legacy_test_parseCVCTDTA()
