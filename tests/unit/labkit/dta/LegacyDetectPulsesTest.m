classdef LegacyDetectPulsesTest < matlab.unittest.TestCase
    %LEGACYDETECTPULSESTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_detectPulses(testCase)
            setupLabKitTestPath();
            legacy_test_detectPulses();
        end
    end
end

function legacy_test_detectPulses()
