classdef LegacyDtaFacadeTest < matlab.unittest.TestCase
    %LEGACYDTAFACADETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_dtaFacade(testCase)
            setupLabKitTestPath();
            legacy_test_dtaFacade();
        end
    end
end

function legacy_test_dtaFacade()
