classdef LegacyParseEISDTATest < matlab.unittest.TestCase
    %LEGACYPARSEEISDTATEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_parseEISDTA(testCase)
            setupLabKitTestPath();
            legacy_test_parseEISDTA();
        end
    end
end

function legacy_test_parseEISDTA()
