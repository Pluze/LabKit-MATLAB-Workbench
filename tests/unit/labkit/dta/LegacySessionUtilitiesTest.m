classdef LegacySessionUtilitiesTest < matlab.unittest.TestCase
    %LEGACYSESSIONUTILITIESTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_sessionUtilities(testCase)
            setupLabKitTestPath();
            legacy_test_sessionUtilities();
        end
    end
end

function legacy_test_sessionUtilities()
