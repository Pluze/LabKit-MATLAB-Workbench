classdef LegacyComputeCICTest < matlab.unittest.TestCase
    %LEGACYCOMPUTECICTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_computeCIC(testCase)
            setupLabKitTestPath();
            legacy_test_computeCIC();
        end
    end
end

function legacy_test_computeCIC()
