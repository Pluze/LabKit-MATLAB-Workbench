classdef LegacyComputeCSCTest < matlab.unittest.TestCase
    %LEGACYCOMPUTECSCTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_computeCSC(testCase)
            setupLabKitTestPath();
            legacy_test_computeCSC();
        end
    end
end

function legacy_test_computeCSC()
