classdef LegacyCicExportTest < matlab.unittest.TestCase
    %LEGACYCICEXPORTTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_cicExport(testCase)
            setupLabKitTestPath();
            legacy_test_cicExport();
        end
    end
end

function legacy_test_cicExport()
