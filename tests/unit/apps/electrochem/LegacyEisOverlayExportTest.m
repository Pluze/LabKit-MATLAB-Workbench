classdef LegacyEisOverlayExportTest < matlab.unittest.TestCase
    %LEGACYEISOVERLAYEXPORTTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_eisOverlayExport(testCase)
            setupLabKitTestPath();
            legacy_test_eisOverlayExport();
        end
    end
end

function legacy_test_eisOverlayExport()
