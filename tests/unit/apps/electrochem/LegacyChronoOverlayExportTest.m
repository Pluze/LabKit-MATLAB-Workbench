classdef LegacyChronoOverlayExportTest < matlab.unittest.TestCase
    %LEGACYCHRONOOVERLAYEXPORTTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_chronoOverlayExport(testCase)
            setupLabKitTestPath();
            legacy_test_chronoOverlayExport();
        end
    end
end

function legacy_test_chronoOverlayExport()
