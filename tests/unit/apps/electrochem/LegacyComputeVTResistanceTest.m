classdef LegacyComputeVTResistanceTest < matlab.unittest.TestCase
    %LEGACYCOMPUTEVTRESISTANCETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Unit'})
        function test_computeVTResistance(testCase)
            setupLabKitTestPath();
            legacy_test_computeVTResistance();
        end
    end
end

function legacy_test_computeVTResistance()
