...
%
% Expected caller: GUI launch and contract tests that need the current app catalog.
...
% app registry.
    ...
    requiredColumns = {'Command', 'DisplayName', 'Family', 'Visibility', 'Folder', ...
    ...
    apps = apps(apps.Visibility == "public", :);
