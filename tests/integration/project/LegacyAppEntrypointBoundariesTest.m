classdef LegacyAppEntrypointBoundariesTest < matlab.unittest.TestCase
    %LEGACYAPPENTRYPOINTBOUNDARIESTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Integration', 'Style'})
        function test_app_entrypoint_boundaries(testCase)
            setupLabKitTestPath();
            legacy_test_app_entrypoint_boundaries();
        end
    end
end

function legacy_test_app_entrypoint_boundaries()
