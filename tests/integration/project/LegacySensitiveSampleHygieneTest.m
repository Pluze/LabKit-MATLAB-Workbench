classdef LegacySensitiveSampleHygieneTest < matlab.unittest.TestCase
    %LEGACYSENSITIVESAMPLEHYGIENETEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Integration', 'Style'})
        function test_sensitive_sample_hygiene(testCase)
            setupLabKitTestPath();
            legacy_test_sensitive_sample_hygiene();
        end
    end
end

function legacy_test_sensitive_sample_hygiene()
