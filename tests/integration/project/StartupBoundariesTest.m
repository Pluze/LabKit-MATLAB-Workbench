...
%TEST_STARTUP_BOUNDARIES Check startup path and root entrypoint boundaries.
    ...
    assert(pathContains(fullfile(root, 'apps', 'templates')), ...
        'startup_labkit should add template app category folders to the path.');
    assert(pathContains(fullfile(root, 'apps', 'templates', 'starter_app')), ...
        'startup_labkit should add nested template app folders to the path.');
    assert(~pathContains(fullfile(root, 'apps', 'templates', 'starter_app', '+starter_app')), ...
        'startup_labkit should not expose template app-owned package folders as direct path entries.');
