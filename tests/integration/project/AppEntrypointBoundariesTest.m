...
%TEST_APP_ENTRYPOINT_BOUNDARIES Verify app locations and entrypoint shape.
    ...
    assert(exist(fullfile(root, 'apps', 'templates'), 'dir') == 7, ...
        'Template apps should live under apps/templates.');
    ...
    templateSource = h.assertAppEntrypoint(root, ...
        'labkit_TemplateApp_app', ...
        'launchTemplateApp', ...
        'template_app_gui(');
    h.assertUsesGuiFoundation(templateSource, 'labkit_TemplateApp_app');
end
