classdef LegacyStartupBoundariesTest < matlab.unittest.TestCase
    %LEGACYSTARTUPBOUNDARIESTEST Official wrapper for migrated legacy coverage.

    methods (Test, TestTags = {'Integration', 'Style'})
        function test_startup_boundaries(testCase)
            setupLabKitTestPath();
            legacy_test_startup_boundaries();
        end
    end
end

function legacy_test_startup_boundaries()
