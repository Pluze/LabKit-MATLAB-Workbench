classdef ProjectDebtGuardrailTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'Integration', 'Style'})
        ...
        function appWorkflowDispatchDebtDoesNotGrow(testCase)
            ...
            unexpectedDispatchFiles = setdiff(dispatchFiles, expectedDispatchFiles);
            testCase.verifyTrue(isempty(unexpectedDispatchFiles), ...
                ['expected-debt: app-owned +core/dispatch.m debt grew. Files: ' ...
                strjoin(cellstr(unexpectedDispatchFiles), ', ')]);
