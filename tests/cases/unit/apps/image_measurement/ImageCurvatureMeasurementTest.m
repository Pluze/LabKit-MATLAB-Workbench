...
function checkTaskFingerprintsTrackInputs()
    ...
    fitTask = curvature.analysisRun.fitTask(points, fitPath, calibration, ...
        struct('doDensify', true, 'denseN', 25));
    sameFitTask = curvature.analysisRun.fitTask(points, fitPath, calibration, ...
        struct('doDensify', true, 'denseN', 25));
    changedFitTask = curvature.analysisRun.fitTask(points, fitPath, calibration, ...
    ...
    lengthTask = curvature.analysisRun.lengthTask( ...
        points, fitPath, calibration);
    changedLengthTask = curvature.analysisRun.lengthTask( ...
        points + [0 1], fitPath, calibration);
    changedPathTask = curvature.analysisRun.lengthTask( ...
