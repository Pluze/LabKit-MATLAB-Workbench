    ...
    methods (Test)
        function writesVerifiedManifestAtomically(testCase)
            ...
            result = labkit.ui.Result( ...
                Outputs={labkit.ui.ResultOutput( ...
        ...
        function marksMissingDeclaredOutputFailedAndAggregatesPartial(testCase)
            ...
            result = labkit.ui.Result( ...
                Outputs={ ...
                    labkit.ui.ResultOutput("present", "primary", "present.txt"), ...
                    labkit.ui.ResultOutput("missing", "secondary", "missing.txt")}, ...
        ...
        function preservesFailedAndSkippedDeclarations(testCase)
            ...
            result = labkit.ui.Result( ...
                Outputs={ ...
                    labkit.ui.ResultOutput("present", "primary", "present.txt"), ...
                    labkit.ui.ResultOutput("failed", "aux", "failed.txt", ...
                        Status="failed", Message="export failed"), ...
                    labkit.ui.ResultOutput("skipped", "aux", "skip.txt", ...
...
function app = testApplication()
    app = labkit.ui.Application( ...
        Command="labkit_ResultWriterTest_app", Id="test.result", ...
        Title="Result writer test", Family="Tests", AppVersion="1.0.0", ...
        Updated="2026-07-19", Requirements=[], ...
        Layout=labkit.ui.Layout.workbench({}), Capabilities="results");
end
