...
function checkPathPanelModes()
    ...
    customChoose = labkit.ui.spec.pathPanel('customChoosePaths', 'Paths', ...
        'mode', 'multiFile', ...
        'chooseLabel', 'Open DTA file(s)', ...
        'clearLabel', 'Clear all');
    assert(strcmp(customChoose.props.chooseLabel, 'Open DTA file(s)'), ...
        'pathPanel chooseLabel should preserve app-authored command wording.');
    assert(strcmp(customChoose.props.clearLabel, 'Clear all'), ...
        'pathPanel clearLabel should preserve app-authored clear command wording.');
