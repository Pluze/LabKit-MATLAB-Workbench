    ...
    methods (Test, TestTags = {'GUI', 'Structural'})
        ...
        function minimal_definition_needs_no_app_lifecycle_callbacks(testCase)
            ...
            fig = labkit.ui.runtime.launch( ...
                @minimalDefinition, @requirements, @minimalVersionInfo);
            h.waitForUiIdle(fig);
...
function info = minimalVersionInfo()
    info = struct("name", "minimal_definition_probe", ...
        "displayName", "Minimal Definition Probe", "family", "Test", ...
