...
changed = labkit.app.StateHandler("lineWidthChanged", @lineWidthChanged, Event="valueChange");
edited = labkit.app.StateHandler("tableEdited", @tableEdited, Event="tableCellEdit");
selected = labkit.app.StateHandler( ...
    "tableSelected", @tableSelected, Event="tableCellSelection");
content = labkit.app.layout.group("controls", { ...
    ...
    labkit.app.layout.slider("lineWidth", Value=1, Limits=[0.5 5], ...
        Bind="project.lineWidth", ValueChanged=changed), ...
...
workspace = workspace.page("analysis", "Analysis", ...
    labkit.app.layout.plotArea("preview", Renderers="draw"));
...
view = labkit.app.view.Snapshot() ...
    ...
    .renderPlot("preview", "draw", state.project.lineWidth);
end
