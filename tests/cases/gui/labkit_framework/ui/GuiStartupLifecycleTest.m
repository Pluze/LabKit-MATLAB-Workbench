classdef GuiStartupLifecycleTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'GUI', 'Structural'})
        ...
        function runtime_v2_reports_ordered_startup_phases(testCase)
            ...
            fig = labkit.ui.runtime.launch(@definition, @requirements, ...
                @versionInfo, "RequestAdapter", @startupRequest);
...
function value = versionInfo()
    value = struct('name', "startup_phase_probe", ...
        'displayName', "Startup Phase Probe", 'family', "Test", ...
