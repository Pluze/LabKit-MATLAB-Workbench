classdef GuiLayoutTTestWizardTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'GUI', 'Structural', 'Workflow'})
        function comparesThreeGroupsWithFirstThenPlotsAndExports(testCase)
            ...
            controlTabs = component(figure, "data").Parent;
            workspaceTabs = component(figure, "dataPage").Parent;
            controlPosition = getpixelposition(controlTabs, true);
            workspacePosition = getpixelposition(workspaceTabs, true);
            testCase.verifyLessThan(controlPosition(1), workspacePosition(1));
