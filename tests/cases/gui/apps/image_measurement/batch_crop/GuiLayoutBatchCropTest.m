classdef GuiLayoutBatchCropTest < matlab.uitest.TestCase
    ...
    methods (Test, TestTags = {'GUI', 'Structural'})
        function batch_crop_layout(testCase)
            ...
            h.assertComponentCounts(fig, struct('Button', 9, 'DropDown', 1, ...
                'Spinner', 6, 'ListBox', 1, 'Table', 1, 'TextArea', 2, 'Axes', 1));
            h.assertButtonContract(fig, {'Open images or folder', 'Clear images', ...
                'Duplicate image', 'Previous image', 'Next image', 'Use image center', ...
                'Choose export folder', 'Export cropped images'});
            h.assertDropdownGroups(fig, h.dropdownGroup({'PNG', 'TIFF', 'JPEG'}, 1));
