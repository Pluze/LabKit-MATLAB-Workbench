    ...
    methods (Test, TestTags = {'GUI', 'Structural', 'Workflow'})
        function batch_crop_workflow_exports_synthetic_crop(testCase)
            ...
            testCase.verifyTrue(any([runtime.resources.scope] == "interaction"), ...
                'Batch crop crop rectangle should be runtime-owned.');
            cropResource = runtime.resources( ...
                [runtime.resources.scope] == "interaction" & ...
                [runtime.resources.id] == "cropRectangle").value;
            testCase.verifyEqual(cropResource.spec.BackgroundEvent, ...
                "previewPointerDown", ...
                'Crop background clicks should route through a semantic V2 event.');
            ...
            labkit.ui.control.setValue(ui, 'cropWidth', 30);
            ui.controls.cropWidth.valueSpinner.ValueChangedFcn( ...
