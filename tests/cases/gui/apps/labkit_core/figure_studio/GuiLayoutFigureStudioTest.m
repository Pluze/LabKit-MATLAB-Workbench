classdef GuiLayoutFigureStudioTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'GUI', 'Structural', 'Workflow'})
        function figure_studio_launches_with_style_library(testCase)
            ...
            testCase.verifyEqual(style.titleFontSize, 24);
            testCase.verifyEqual(style.labelFontSize, 24);
            testCase.verifyEqual(style.tickFontSize, 20);
            testCase.verifyEqual(style.annotationFontSize, 20);
            testCase.verifyEqual(style.legendFontSize, 15);
            testCase.verifyEqual(style.dataLineWidth, 1.2);
            testCase.verifyEqual(style.uncertaintyLineWidth, 1.1);
            testCase.verifyEqual(style.boundaryLineWidth, 1.1);
            testCase.verifyEqual(style.referenceLineWidth, 1.2);
            testCase.verifyEqual(style.axesLineWidth, 1.2);
        ...
        function figure_studio_accepts_popout_axes_handoff(testCase)
            ...
            testCase.verifyEqual( ...
                initialProject.parameters.style.tickFontSize, 20);
            testCase.verifyEqual( ...
                initialProject.parameters.style.axesLineWidth, 1.2);
            testCase.verifyEqual( ...
