classdef ProjectDocumentationGuardrailTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'Integration', 'Style'})
        ...
        function generatedOrderedListsPreserveItemsAndContinuations(testCase)
            root = setupLabKitTestPath();
        ...
        function generatedHistoryUsesOneTimelineForEveryEra(testCase)
            root = setupLabKitTestPath();
        ...
        function generatedApiProseLinksKnownPublicSymbols(testCase)
            root = setupLabKitTestPath();
            page = string(fileread(fullfile(root, "site", "reference", ...
