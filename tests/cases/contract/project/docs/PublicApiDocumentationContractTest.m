...
function files = rewrittenModuleFiles(root)
    ...
    appSources = [ ...
        ...
        fullfile("apps", "gait", "gait_analysis", ...
            "+gait_analysis", "+analysisRun", "computeGait.m"), ...
        fullfile("apps", "image_measurement", "batch_crop", ...
            "+batch_crop", "+cropGeometry", "cropImage.m"), ...
        fullfile("apps", "image_measurement", "batch_crop", ...
            "+batch_crop", "+cropGeometry", "cropScaledImage.m"), ...
        fullfile("apps", "image_measurement", "batch_crop", ...
            "+batch_crop", "+cropGeometry", "scalePlan.m"), ...
        fullfile("apps", "image_measurement", "curvature", ...
            "+curvature", "+analysisRun", "computeCurvatureFit.m"), ...
        fullfile("apps", "image_measurement", "curvature", ...
            "+curvature", "+analysisRun", "computeCurveLength.m"), ...
        fullfile("apps", "image_measurement", "flir_thermal", ...
            "+flir_thermal", "+analysisRun", "extremeTemperatureReadings.m"), ...
        fullfile("apps", "image_measurement", "flir_thermal", ...
            "+flir_thermal", "+analysisRun", "pointTemperatureReading.m"), ...
        fullfile("apps", "image_measurement", "flir_thermal", ...
            "+flir_thermal", "+analysisRun", "roiTemperatureMeanReading.m"), ...
        fullfile("apps", "image_measurement", "focus_stack", ...
            "+focus_stack", "+analysisRun", "computeFocusStack.m"), ...
        fullfile("apps", "image_measurement", "image_enhance", ...
            "+image_enhance", "+analysisRun", "applyPipeline.m"), ...
        fullfile("apps", "image_measurement", "image_match", ...
            "+image_match", "+analysisRun", "applyMatch.m"), ...
        fullfile("apps", "image_measurement", "image_match", ...
            "+image_match", "+analysisRun", "applyPipeline.m"), ...
        fullfile("apps", "image_measurement", "video_marker", ...
            "+video_marker", "+coordinateExport", "buildTable.m"), ...
        fullfile("apps", "image_measurement", "video_marker", ...
            "+video_marker", "+motionEstimate", "trackPoints.m"), ...
        fullfile("apps", "neurophysiology", "nerve_response_analysis", ...
        ...
        fullfile("apps", "neurophysiology", "nerve_response_analysis", ...
            "+nerve_response_analysis", "+analysisRun", ...
            "measureCapMetrics.m"), ...
        fullfile("apps", "neurophysiology", "response_review_stats", ...
            "+response_review_stats", "+analysisRun", "alignSegments.m"), ...
        fullfile("apps", "neurophysiology", "response_review_stats", ...
            "+response_review_stats", "+analysisRun", ...
            "measureAlignedSegments.m"), ...
        fullfile("apps", "neurophysiology", "response_review_stats", ...
            "+response_review_stats", "+analysisRun", "summarizeMetrics.m"), ...
        fullfile("apps", "neurophysiology", "rhs_preview", ...
            "+rhs_preview", "+analysisRun", "readPreviewWindow.m"), ...
        fullfile("apps", "wearable", "ecg_print", ...
            "+ecg_print", "+analysisRun", "analyzeSignal.m")];
