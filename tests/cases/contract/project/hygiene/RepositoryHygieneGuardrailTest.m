classdef RepositoryHygieneGuardrailTest < matlab.unittest.TestCase
    ...
    methods (Test, TestTags = {'Integration', 'Style'})
        ...
        function helperQualityAuditReportsShortHelperMetadata(testCase)
            root = setupLabKitTestPath();
            audit = labkitHelperQualityAudit(root, "MaxLines", 20);

            expectedColumns = ["RelativePath", "Lines", "RolePackage", ...
                "FunctionCount", "CallCount", "PublicStatus", ...
                "DirectUnitTestReferences", "AllowedException", ...
                "Recommendation"];
            testCase.verifyEqual(string(audit.Properties.VariableNames), ...
                expectedColumns);
            testCase.verifyTrue(any(audit.RelativePath == ...
                "apps/image_measurement/focus_stack/+focus_stack/+io/supportedImageExtensions.m"), ...
