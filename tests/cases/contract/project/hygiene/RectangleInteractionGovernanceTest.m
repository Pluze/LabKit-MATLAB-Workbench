    ...
    methods (Test, TestTags = {'Integration', 'Style'})
        ...
        function knownInteractiveWorkflowsDeclareSemanticInteractions(testCase)
            ...
            rectangleLayouts = [
                ...
                "apps/image_measurement/flir_thermal/+flir_thermal/+workbench/buildLayout.m"
            ];
            ...
            testCase.verifyTrue(contains(flirLayout, ...
                'labkit.app.interaction.pointSlots("temperaturePoint"') && ...
                contains(flirLayout, ...
                'labkit.app.interaction.rectangle("temperatureRegion"'), ...
                ['FLIR point and ROI reads must use App SDK managed ' ...
                'point and rectangle interactions.']);
        end
    end
end
