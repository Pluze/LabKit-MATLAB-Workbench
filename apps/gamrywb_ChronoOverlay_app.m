...
%GAMRYWB_CHRONOOVERLAY_APP Chrono voltage/current overlay and export app.
% Single-file app that composes +gamrywb GUI/DTA APIs and owns overlay workflow choices.
