...
%LABKIT_DICPOSTPROCESS_APP Ncorr strain summary and overlay export app.
    ...
    txtMat = labkit.ui.createReadOnlyTextField(fileGrid, 'Value', 'No MAT file loaded');
    txtMat.Layout.Row = 3;
    txtMat.Layout.Column = [1 2];
    txtReference = labkit.ui.createReadOnlyTextField(fileGrid, 'Value', 'No reference image loaded');
    txtReference.Layout.Row = 4;
    txtReference.Layout.Column = [1 2];
    txtMask = labkit.ui.createReadOnlyTextField(fileGrid, 'Value', 'No mask image loaded');
    ...
    optionPanel = labkit.ui.createPanelGrid(layFA, 'Overlay Options', 2, [6 2], ...
        struct('rowHeight', {{'fit', 'fit', 'fit', 'fit', 'fit', 'fit'}}));
    optionGrid = optionPanel.grid;

    [~, edAlpha] = labkit.ui.createLabeledSpinner(optionGrid, 'Alpha:', ...
        'Value', 0.60, 'Limits', [0 1], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edMin] = labkit.ui.createLabeledSpinner(optionGrid, 'Color min:', ...
        'Value', -0.15, 'Step', 0.01, 'ValueChangedFcn', @onOptionsChanged);
    [~, edMax] = labkit.ui.createLabeledSpinner(optionGrid, 'Color max:', ...
        'Value', 0.15, 'Step', 0.01, 'ValueChangedFcn', @onOptionsChanged);
    [~, edOversample] = labkit.ui.createLabeledSpinner(optionGrid, 'Oversample:', ...
        'Value', 6, 'Limits', [1 20], 'Step', 1, 'ValueChangedFcn', @onOptionsChanged);
    [~, edSigma] = labkit.ui.createLabeledSpinner(optionGrid, 'Smooth sigma:', ...
        'Value', 0.8, 'Limits', [0 Inf], 'Step', 0.1, 'ValueChangedFcn', @onOptionsChanged);
    [~, edResolution] = labkit.ui.createLabeledSpinner(optionGrid, 'Export DPI:', ...
        'Value', 1000, 'Limits', [72 2400], 'Step', 50);

    imagePanel = labkit.ui.createPanelGrid(layFA, 'Optical Image Enhancement', 3, [7 2], ...
        struct('rowHeight', {{'fit', 'fit', 'fit', 'fit', 'fit', 'fit', 'fit'}}));
    imageGrid = imagePanel.grid;

    [~, edBrightness] = labkit.ui.createLabeledSpinner(imageGrid, 'Brightness:', ...
        'Value', 0, 'Limits', [-1 1], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edContrast] = labkit.ui.createLabeledSpinner(imageGrid, 'Contrast:', ...
        'Value', 1, 'Limits', [0.05 5], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edGamma] = labkit.ui.createLabeledSpinner(imageGrid, 'Gamma:', ...
        'Value', 1, 'Limits', [0.05 5], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edSaturation] = labkit.ui.createLabeledSpinner(imageGrid, 'Saturation:', ...
        'Value', 1, 'Limits', [0 5], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edRedGain] = labkit.ui.createLabeledSpinner(imageGrid, 'Red gain:', ...
        'Value', 1, 'Limits', [0 5], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edGreenGain] = labkit.ui.createLabeledSpinner(imageGrid, 'Green gain:', ...
        'Value', 1, 'Limits', [0 5], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);
    [~, edBlueGain] = labkit.ui.createLabeledSpinner(imageGrid, 'Blue gain:', ...
        'Value', 1, 'Limits', [0 5], 'Step', 0.05, 'ValueChangedFcn', @onOptionsChanged);

    exportPanel = labkit.ui.createPanelGrid(layFA, 'Exports', 4, [3 2], ...
