% App-owned DIC preprocess preview layout helper. Expected caller:
% dic_preprocess.ui.createLayout. Inputs are the shell UI struct, axes titles,
% and whether plot-control panels are needed. Output is the UI struct with
...
%CREATERIGHTAXESPAIR Create DIC preprocess preview axes.
