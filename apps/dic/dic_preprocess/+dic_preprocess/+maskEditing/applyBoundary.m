% App-owned implementation for dic_preprocess.maskEditing.applyBoundary within the dic_preprocess product workflow.
...
callbackContext.log("info", "dic_preprocess.maskediting.applyboundary.status",  ...
