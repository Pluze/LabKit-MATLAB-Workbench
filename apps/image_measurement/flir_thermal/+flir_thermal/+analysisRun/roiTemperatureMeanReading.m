...
%   flir_thermal.analysisRun.roiTemperatureMeanReading(T, startXY, endXY)
%   accepts a 2-D Celsius matrix and two opposite [x y] corners. Pixel bounds
%   are rounded, ordered, and clamped. Non-finite pixels are excluded.
%   hotSpot and coldSpot contain x, y, and temperatureC. meanReading also
%   contains x, y, width, height, and pixelCount. Invalid or all-nonfinite
%   inputs return stable empty records with NaN measurements.
%
%   Example:
%     [hot, cold, avg] = ...
%       flir_thermal.analysisRun.roiTemperatureMeanReading(T,[10 20],[40 60]);
%
