...
% labkit_FocusStack_app and focusStackWorkflow. Inputs are raw uigetfile values.
...
%SELECTEDFOCUSIMAGEPATHS Normalize manually selected focus-stack image paths.
% Expected caller: labkit_FocusStack_app and focusStackWorkflow. Inputs are the
