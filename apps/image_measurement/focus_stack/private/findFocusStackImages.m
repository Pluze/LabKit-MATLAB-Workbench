...
% labkit_FocusStack_app and focusStackWorkflow. Input is a folder path. Output
...
%FINDFOCUSSTACKIMAGES Find supported focus-stack image files in a folder.
% Expected caller: labkit_FocusStack_app and focusStackWorkflow. Input is a
