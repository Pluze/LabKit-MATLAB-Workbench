...
function T = buildSummaryTable(result, paths)
%BUILDSUMMARYTABLE Build summary CSV table for labkit_FocusStack_app.
%
% Expected caller:
%   labkit_FocusStack_app export callback and package tests.
%
% Inputs/outputs:
