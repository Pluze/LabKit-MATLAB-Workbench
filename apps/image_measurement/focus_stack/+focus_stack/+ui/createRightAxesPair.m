% App-owned focus-stack preview layout helper. Expected caller:
% labkit_FocusStack_app. Inputs are the shell UI struct, axes titles, and
...
%CREATERIGHTAXESPAIR Create focus-stack preview axes.
