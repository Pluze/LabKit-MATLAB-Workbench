...
% package loading helpers. Input is a path vector. Output is a string column
% sorted by base filename plus extension.
function paths = sortPathsByName(paths)
%SORTPATHSBYNAME Sort focus-stack paths by case-insensitive name.
