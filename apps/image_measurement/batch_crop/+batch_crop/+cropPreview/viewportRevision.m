...
% the durable source ID, decoded working item, and prepared geometry. Output
% changes for a new source or canvas transform, while crop/scale overlays on
% that canvas preserve zoom.
function revision = viewportRevision(sourceId, item, geometry)
