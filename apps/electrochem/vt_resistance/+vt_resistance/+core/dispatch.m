% App-owned VT resistance helper core dispatch. Expected caller:
% labkit_VTResistance_app callbacks and package tests.
...
%DISPATCH Route VT resistance package wrapper calls to app-owned helpers.
% Expected caller: labkit_VTResistance_app callbacks and % package tests. Inputs are a command string plus the original helper arguments.
