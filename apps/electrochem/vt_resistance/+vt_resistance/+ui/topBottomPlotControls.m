% App-owned VT Resistance top/bottom plot controls helper. Expected caller:
% vt_resistance.ui.runApp. Inputs are parent panels, axis items, default
...
%TOPBOTTOMPLOTCONTROLS Create VT Resistance top/bottom plot controls.
