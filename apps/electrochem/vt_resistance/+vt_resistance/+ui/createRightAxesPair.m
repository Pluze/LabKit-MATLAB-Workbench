% App-owned VT Resistance right-side axes layout helper. Expected caller:
% vt_resistance.ui.runApp. Inputs are the shell UI struct, axes titles, and
% whether plot-control panels are needed. Output is the UI struct with
% top/bottom axes and panel fields. Side effects are limited to creating
% controls on the shell right grid.
function ui = createRightAxesPair(ui, topTitle, bottomTitle, showControls)
%CREATERIGHTAXESPAIR Create VT Resistance top/bottom plot axes.
