...
function [x, xLabel, coords] = xPayload(A, xChoice)
    ...
    if strcmp(xChoice, choices.xAxes(2))
        ...
        coords = struct( ...
            'cathStartX', interp1Safe(A.t, A.pt, A.pulse.cath.start_s), ...
            'cathEndX', interp1Safe(A.t, A.pt, A.pulse.cath.end_s), ...
            'anodStartX', interp1Safe(A.t, A.pt, A.pulse.anod.start_s), ...
            'anodEndX', interp1Safe(A.t, A.pt, A.pulse.anod.end_s), ...
        ...
        coords = struct( ...
            'cathStartX', A.pulse.cath.start_s, ...
            'cathEndX', A.pulse.cath.end_s, ...
            'anodStartX', A.pulse.anod.start_s, ...
            'anodEndX', A.pulse.anod.end_s, ...
            'emcX', A.t_emc, ...
            'emaX', A.t_ema);
    end
end
