% App-owned CSC right-side axes layout helper. Expected caller: csc.ui.buildControls.
% Inputs are the shell UI struct, axes titles, and whether plot-control panels
% are needed. Output is the UI struct with top/bottom axes and panel fields.
% Side effects are limited to creating controls on the shell right grid.
function ui = createRightAxesPair(ui, topTitle, bottomTitle, showControls)
%CREATERIGHTAXESPAIR Create CSC top/bottom plot axes.
