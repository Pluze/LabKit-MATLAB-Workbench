...
view = labkit.app.view.Snapshot() ...
    ...
    .renderPlot("plotAxes", model, ...
        ViewRevision=viewportRevision(applicationState, index, axisValues)) ...
...
function revision = viewportRevision(applicationState, index, axisValues)
p = applicationState.project.parameters;
selection = applicationState.session.selection;
revision = string(jsonencode(struct( ...
    "sourceIds", {selectedSourceIds( ...
        applicationState.project.inputs.sources, selection.files)}, ...
    "selectedIndex", index, ...
    "currentCurve", string(selection.currentCurve), ...
    "ignoreEdgeCycles", logical(p.ignoreEdgeCycles), ...
    "topX", string(axisValues.topX), ...
    "topY", string(axisValues.topY), ...
    "topHold", logical(p.topHold), ...
    "bottomX", string(axisValues.bottomX), ...
    "bottomY", string(axisValues.bottomY), ...
    "bottomHold", logical(p.bottomHold))));
end
