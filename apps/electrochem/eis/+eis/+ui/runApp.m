...
%RUNEISAPP Build and run the app body.
    ...
    plotOptionsUi = labkit.ui.view.section(layFA, 'Plot Options', 2, [8 2]);
    gp = plotOptionsUi.grid;

    [~, ddX] = labkit.ui.view.form(gp, struct( ...
        'kind', 'dropdown', ...
        'label', 'X axis:', ...
        'items', {axisItems}, ...
        'value', 'Zreal (ohm)', ...
    ...
    [~, ddY] = labkit.ui.view.form(gp, struct( ...
        'kind', 'dropdown', ...
        'label', 'Y axis:', ...
        'items', {axisItems}, ...
        'value', '-Zimag (ohm)', ...
    ...
    [~, edMarkerSize] = labkit.ui.view.form(gp, struct( ...
        'kind', 'spinner', ...
        'label', 'Marker size:', ...
        'value', 6, ...
        'limits', [1 20], ...
