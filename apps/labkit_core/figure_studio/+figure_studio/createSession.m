...
function session = createSession(project, context)
    ...
    if isfield(project, "parameters") && isfield(project.parameters, "style") && ...
            isfield(project.parameters.style, "tickDirection")
        limitState.tickDir = string(project.parameters.style.tickDirection);
    end
    session = struct( ...
        "selection", struct( ...
