...
function view = presentWorkbench(state)
    ...
    view.controls.rhsFile = sourcePanel( ...
        state.project.inputs.rhsSource, "No RHS file selected");
    view.controls.rhsFolder = sourcePanel( ...
        state.project.inputs.filterSources, "No RHS files selected");
...
function context = previewContext(state)
    context = struct( ...
        ...
        "rhsFolder", commonParent(state.project.inputs.filterSources), ...
