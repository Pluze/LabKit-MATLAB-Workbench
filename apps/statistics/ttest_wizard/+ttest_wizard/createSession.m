...
% current source is read strictly into a transient cell grid; copied groups
% remain durable in project state. Existing unreadable sources throw
% so project loading cannot silently erase the table. Reading is the only side
% effect.
