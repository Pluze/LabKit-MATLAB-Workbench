...
| Curvature | circle/length science, invalid-curve branches, fit/length task fingerprints, source migration, result schema, source/presentation, generic semantic layout | Split: restore fit-and-export workflow proof. |
