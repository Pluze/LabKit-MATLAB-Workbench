...
- Package-root app `run.m` orchestration and `+ui/runApp.m` lifecycle adapters
  are retired.
- Eighteen public apps now use Runtime V2: `chrono_overlay`, `cic`, `csc`, `eis`,
  ...
  `image_enhance`, `image_match`, and `flir_thermal`. Two public apps and the nested private
  app still use the v1 definition path.
