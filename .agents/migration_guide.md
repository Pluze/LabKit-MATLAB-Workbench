...
| FLIR Thermal | extrema, ROI measurement, project/result/source/presentation, shared display range, bounded radiometric display/reading/export/restore workflow, generic semantic layout | Split: direct raw fallback and correction/default-warning branch parity remains to be restored. |
