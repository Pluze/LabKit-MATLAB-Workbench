...
- Chrono Overlay, EIS, and VT Resistance now prove the final workflow-first app
  package shape:
  ...
  buckets.
- The other 14 app packages still use transitional `+state`, `+actions`,
...
2. App migration
   ...
   - Chrono Overlay, EIS, and VT Resistance are representative
