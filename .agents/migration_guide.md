...
| Figure Studio | style, overlay order, source limits/geometry, composite FIG import/export, version migrations, project/presentation, generic semantic layout | Split: canvas/title/log-axis edge cases, source handoff, and interactive preview/export workflows remain. |
