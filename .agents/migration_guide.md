...
- Package-root app `run.m` orchestration and `+ui/runApp.m` lifecycle adapters
  are retired.
- Seventeen public apps now use Runtime V2: `chrono_overlay`, `cic`, `csc`, `eis`,
  ...
  `image_enhance`, and `image_match`. Three public apps and the nested private
