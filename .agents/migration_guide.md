...
| Remaining 3 tracked Apps | Pending | Captured `main` and replacement all-tab baselines exist; Gait Analysis, ECG Print, and Video Marker still require control/function/state audit and focused validation |
