...
There is no active architecture or test-routing migration. Durable test
ownership and changed-file routing rules live in `tests/AGENTS.md`, the test
planner skill, and the testing manual. Their completion evidence is recorded in
