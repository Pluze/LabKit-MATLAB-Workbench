...
%
% App-facing contract:
%   folder = labkit.ui.app.defaultOutputFolder(sourcePaths, subfolderName)
%   folder = labkit.ui.app.defaultOutputFolder(..., fallbackFolder)
%
% Inputs:
...
%       output dialog folder.
    ...
    if strlength(baseFolder) == 0
        baseFolder = string(labkit.ui.app.defaultDialogFolder("output", fallbackFolder));
    end
    ...
    folder = labkit.ui.app.defaultDialogFolder("output", fallbackFolder);
end
