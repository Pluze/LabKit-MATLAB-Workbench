% Private UI app helper. Expected caller: buildWorkspace preview-area setup.
% Input is a UI axes. Output mutates the axes and children in place so the
% standard LabKit popout action remains available without depending on the
% migration-era public draw helper.
