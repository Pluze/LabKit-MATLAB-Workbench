% Private UI control helper. Expected caller: labkit.ui.control or labkit.ui.plot panel, control,
...
%
% Usage:
%   [value, idx] = refreshListboxSelection(lb, names, oldValue);
%   [value, idx] = refreshListboxSelection(lb, names, [], ...
