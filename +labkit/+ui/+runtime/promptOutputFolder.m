...
%
% App-facing contract:
%   folder = labkit.ui.runtime.promptOutputFolder(titleText, defaultFolder)
%   [folder, cancelled] = labkit.ui.runtime.promptOutputFolder(...)
%   [...] = labkit.ui.runtime.promptOutputFolder(..., "Chooser", chooserFcn)
%
% Inputs:
%   titleText - dialog title. Defaults to "Select output folder".
%   defaultFolder - preferred output folder. It is passed through
%       labkit.ui.runtime.defaultDialogFolder("output", defaultFolder).
...
%   cancelled - true when the chooser was canceled.
    ...
    safeDefaultFolder = labkit.ui.runtime.defaultDialogFolder("output", defaultFolder);
