...
%
% App-facing contract:
%   filepath = labkit.ui.runtime.promptOutputFile(filterSpec, title, defaultPath)
%   [filepath, cancelled] = labkit.ui.runtime.promptOutputFile(...)
%   [...] = labkit.ui.runtime.promptOutputFile(..., "Chooser", chooserFcn)
%
% Inputs:
...
%       through labkit.ui.runtime.defaultDialogFolder("output", folder).
...
function pathValue = outputDefaultPath(defaultPath)
    ...
    safeFolder = labkit.ui.runtime.defaultDialogFolder("output", folder);
