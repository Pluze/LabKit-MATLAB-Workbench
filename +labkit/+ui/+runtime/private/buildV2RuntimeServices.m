...
function services = buildV2RuntimeServices(fig, runtime, dispatch)
    ...
    services.resources = struct( ...
        "set", @(scope, id, value, varargin) setResource( ...
            fig, scope, id, value, varargin{:}), ...
...
function setResource(fig, scope, id, value, varargin)
    v2ResourceRegistry(fig, "set", scope, id, value, varargin{:});
end
