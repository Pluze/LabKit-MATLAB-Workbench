...
%
% Errors:
%   labkit:app:interaction:InvalidImageSize - imageSize lacks positive finite
%   height and width.
%   labkit:app:interaction:InvalidScaleBar - calibration or barLength is not a
%   positive finite scalar.
%   labkit:app:interaction:ScaleBarTooLong - The requested bar does not fit
