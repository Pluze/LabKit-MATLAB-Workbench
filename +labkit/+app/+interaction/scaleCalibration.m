function cal = scaleCalibration(referencePixels, referenceLength, unitName, opts)
%SCALECALIBRATION Convert a known image distance into pixels per unit.
%
% Usage:
%   cal = labkit.app.interaction.scaleCalibration(referencePixels, ...
%       referenceLength, unitName)
%   cal = labkit.app.interaction.scaleCalibration(..., opts)
%
% Inputs:
