classdef (Hidden, Sealed) SyntheticInputGenerator
    ...
    methods (Static)
        function pack = generate(definition, folder)
            ...
            labkit.app.internal.SyntheticInputGenerator.validateProject( ...
                definition, pack);
            labkit.app.internal.SyntheticInputGenerator.verifyArtifacts( ...
                context, pack);
            labkit.app.internal.SyntheticInputGenerator.writeManifest( ...
                context, pack);
        end
    end
