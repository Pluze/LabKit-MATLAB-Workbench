...
%   Only one runtime session owns a given image axes at a time.
    ...
    function curve = curvePointsForCurrentState()
        ...
        curve = labkit.app.interaction.interpolateAnchorPath(state.points, state.imageSize, ...
    ...
    function points = addPoint(points, point)
        ...
        points = labkit.app.internal.interaction.addOrInsertAnchor( ...
...
function key = anchorEditorAppdataKey()
    key = 'labkitAppActiveAnchorEditor';
end
