    ...
    methods (Access = private)
        function createFigure(obj)
            ...
            filters = uigridlayout(root, [2 8], ...
                RowHeight={30, 30}, ...
                ColumnWidth={55, "1x", 45, 105, 62, 110, 70, 90}, ...
            ...
            label = uilabel(filters, Text="Audience");
            label.Layout.Row = 1;
            label.Layout.Column = 5;
            obj.AudienceFilter = uidropdown(filters, ...
                Items=["Default", "All", "User", "Developer"], ...
            ...
            label = uilabel(filters, Text="Root");
            label.Layout.Row = 2;
            label.Layout.Column = 3;
        ...
        function updateChoices(~, dropdown, values)
            current = string(dropdown.Value);
            values = string(values(:)).';
            dropdown.Items = ["(All)", values];
