classdef (Hidden, Sealed) SessionLogViewer < handle
    ...
    methods
        function obj = SessionLogViewer(runtime)
            ...
            obj.Runtime = runtime;
            obj.Projection = labkit.app.internal.SessionLogProjection( ...
    ...
    methods (Access = private)
        function createFigure(obj)
            ...
            filters = uigridlayout(root, [2 8], ...
                RowHeight={30, 30}, ...
                ColumnWidth={55, "1x", 45, 110, 40, 155, 70, 90}, ...
            ...
            obj.LevelFilter = uidropdown(filters, ...
                Items=["Default", "TRACE+", "DEBUG+", "INFO+", ...
                    "WARNING+", "ERROR+", "CRITICAL"], ...
                ItemsData=["default", "trace", "debug", "info", ...
                    "warning", "error", "critical"], ...
                ValueChangedFcn=@(~, ~) obj.applyFilters(), ...
                Tag="labkitSessionLogLevel");
            obj.LevelFilter.Value = "default";
            obj.LevelFilter.Layout.Row = 1;
            obj.LevelFilter.Layout.Column = 4;
            label = uilabel(filters, Text="View", ...
                Tooltip="Choose user workflow events, developer internals, or both.", ...
                Tag="labkitSessionLogAudienceLabel");
            label.Layout.Row = 1;
            label.Layout.Column = 5;
            obj.AudienceFilter = uidropdown(filters, ...
                Items=["Useful (default)", "Everything", ...
                    "User workflow", "Developer details"], ...
                ItemsData=["default", "all", "user", "developer"], ...
                Tooltip=[ ...
                    "Useful shows user events plus developer warnings and errors. " ...
                    "Developer details requires DEBUG+ to show normal callback boundaries."], ...
                ValueChangedFcn=@(~, ~) obj.applyFilters(), ...
                Tag="labkitSessionLogAudience");
            obj.AudienceFilter.Value = "default";
            obj.AudienceFilter.Layout.Row = 1;
            obj.AudienceFilter.Layout.Column = 6;
            ...
            obj.RootFilter.Layout.Column = [4 8];
            obj.FollowButton = uibutton(filters, ...
                Text="Pause follow", ...
                ButtonPushedFcn=@(~, ~) obj.toggleFollow(), ...
                Tag="labkitSessionLogFollow");
        ...
        function applyFilters(obj)
            obj.Projection.setFilters( ...
                ...
                Audience=string(obj.AudienceFilter.Value), ...
        ...
        function toggleFollow(obj)
            obj.FollowLatest = ~obj.FollowLatest;
            if obj.FollowLatest
                obj.FollowButton.Text = "Pause follow";
                obj.followLatest();
            else
                obj.FollowButton.Text = "Follow latest";
            end
        end
        ...
        function refreshView(obj, incremental)
            ...
            if obj.FollowLatest && (appended || ~incremental)
                obj.followLatest();
            end
        end
