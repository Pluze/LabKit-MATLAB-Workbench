function xy = offsetPointByAxesFraction(ax, xy, offsetFraction)
%OFFSETPOINTBYAXESFRACTION Move data coordinates by normalized axes fractions.
%
% Usage:
...
%   labkit:app:plot:InvalidPointOffsets - offsetFraction is neither one row nor
%   one row per point.
%
% Example:
