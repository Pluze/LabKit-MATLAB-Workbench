classdef (Sealed) Artifact
    ...
    %   beneath a synthetic-input root without exposing a user file path.
    %
    % Inputs:
    %   id - Nonempty semantic identifier unique within a Pack.
    %   role - Nonempty App-owned artifact purpose.
    %   relativePath - Nonempty synthetic-root-relative path without
    %       traversal.
    %
    ...
    %
    % Outputs:
    %   artifact - Immutable synthetic-input artifact value.
    %
    % Errors:
    ...
    methods
        function obj = Artifact(id, role, relativePath, varargin)
            options = labkit.app.internal.OptionParser.parse( ...
                "labkit.app.synthetic.Artifact", "Expectation", ...
                varargin{:});
            ...
            if ~any(expectation == ...
                ...
                error("labkit:app:contract:InvalidValue", ...
                    "Synthetic Artifact Expectation is unsupported.");
            end
...
if startsWith(value, "/") || startsWith(value, "//") || ...
    ...
    invalid("RelativePath must be synthetic-root-relative.");
end
parts = split(value, "/");
if any(parts == ["", ".", ".."], "all")
...
error("labkit:app:contract:InvalidValue", ...
    "Synthetic Artifact " + message, varargin{:});
end
