classdef (Sealed) SamplePack
    %SAMPLEPACK Describe one typed anonymous App reproduction scenario.
    %
    % Usage:
    ...
    %   Artifacts - Row cell array of labkit.app.diagnostic.Artifact values.
    ...
    methods
        function obj = SamplePack(varargin)
            ...
            if ~iscell(artifacts) || ...
                    ...
                    "labkit.app.diagnostic.Artifact") && isscalar(value), ...
                    artifacts))
            ...
            if numel(unique(ids)) ~= numel(ids) || ...
                ...
                error("labkit:app:contract:DuplicateId", ...
                    "Diagnostic SamplePack artifact IDs and paths must be unique.");
            end
...
error("labkit:app:contract:InvalidValue", ...
    "Diagnostic SamplePack " + message, varargin{:});
end
