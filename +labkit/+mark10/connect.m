...
%
% Description:
%   Starts one persistent Base MATLAB background worker which exclusively
%   owns the physical serial port from Connect through Disconnect. The
%   returned token is a command-and-snapshot proxy; callers never own or
%   transfer the serialport object.
%
% Inputs:
...
try
    ...
    failure = MException("labkit:mark10:ConnectionFailed", ...
        "Could not open or probe the selected Mark-10 port.");
