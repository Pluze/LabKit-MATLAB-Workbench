...
% Own the physical Mark-10 connection and acquisition loop off the client.
...
while running
    ...
    if nextDue_s < sample.HostTime_s
        nextDue_s = sample.HostTime_s;
    end
...
try
    ...
    value = event("failure", requestId, {failure}, connection);
    send(events, value);
end
end
