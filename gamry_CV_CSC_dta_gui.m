...
%   gamry_dta_gui
    ...
    function loadFile(filepath)
        ...
        try
            [scanRate, curves, parserLog] = parseGamryDTA(filepath);
        catch ME
...
function [scanRate, curves, logmsg] = parseGamryDTA(filepath)
