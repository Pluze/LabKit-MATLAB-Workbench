...
type: tutorial
audience: new-user
summary: This guide covers the shortest path from an empty folder to a running LabKit app. For source development, continue with the development guide.
```

This guide covers the shortest path from an empty folder to a running LabKit app. For source development, continue with the [development guide](../develop/README.md).
...
See [Testing](../maintain/testing.md) before choosing a broader build task.
