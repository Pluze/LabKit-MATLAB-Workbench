...
scope: Cross-release equal-data-unit plot fitting
```
...
- Open anchor paths prepend beyond the visible start, append beyond the visible
  end, and insert other additions into the nearest visible segment independent
  of axes zoom.
