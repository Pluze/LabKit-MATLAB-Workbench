...
- The legacy multi-DTA overlay, EIS overlay, VT resistance, and CIC GUIs have started using shared session helpers while preserving their legacy `S.items` display/export surfaces.
