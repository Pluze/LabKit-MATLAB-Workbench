...
- `+app`: Chrono/EIS/VT resistance/CIC app launch assembly and shared app/session orchestration helpers such as duplicate-aware file loading, selected-item lookup, and selected-item removal.
