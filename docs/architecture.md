...
- The legacy multi-DTA overlay and EIS overlay GUIs have started using shared session add/remove helpers while preserving their legacy `S.items` display/export surfaces.
