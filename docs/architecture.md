...
- The legacy multi-DTA overlay, EIS overlay, and VT resistance GUIs have started using shared session helpers while preserving their legacy `S.items` display/export surfaces.
