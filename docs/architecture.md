...
- `+ui`: VT resistance and CIC batch table display data; shared app axes creation/reset, log, file-listbox, file-panel, info/log text-area, plot-options panel, simple labeled-control, and two-pane shell helpers.
