...
type: landing
audience: app-user
summary: Choose a statistics workflow that keeps data preparation, hypothesis testing, completed results, and figure design as explicit separate steps.
```
...
For exchange between Apps and scripts, prefer the [Scientific CSV file contract](../../../reference/schemas/scientific-csv.md): one header row, one rectangular table, readable labels, and blank cells for missing values. This is a lowest-layer table contract, not a universal experiment schema.
