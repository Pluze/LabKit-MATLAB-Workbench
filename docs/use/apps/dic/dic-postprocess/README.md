...
```labkit-page
id: app-dic-postprocess
type: landing
audience: app-user
summary: Convert Ncorr strain fields into EXX and EYY overlays and calculate descriptive strain statistics over a validated region of interest.
```
...
4. Optionally tune optical-image brightness, contrast, gamma, saturation, and RGB gains.
