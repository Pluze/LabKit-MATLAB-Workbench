...
[Development index](../README.md) | [App development](../build-apps/app-development.md)
...
project spec. See [Build a Complete App](../build-apps/complete-app.md) for a working
file-by-file example and [Runtime and Lifecycle](../../framework/guides/runtime.md) for
