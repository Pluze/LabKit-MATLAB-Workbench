...
3. Click anywhere in the preview to place the crop center. Drag the center
   marker or anywhere inside the highlighted ROI to move it, or enter center
   X/Y.
...
including inside the rectangle. Change crop width and height with their
controls. Editing the ROI updates the selected task immediately;
